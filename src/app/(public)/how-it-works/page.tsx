...
export default async function HowItWorksPage() {
  ...
  const steps = [
    ...
    {
      title: "2. Ufuk registers and supports the child on the ground",
      body: "Ufuk, our implementing partner in Gaza, registers the child, delivers quarterly support, documents school progress, and prepares updates for MyFundAction.",
    },
    {
      title: "3. MyFundAction reviews everything before it reaches you",
      body: "Every report, photo, and delivery record submitted by Ufuk is checked by our team. Nothing reaches your sponsor portal until it's been reviewed and approved.",
    },
    {
    ...
    },
    {
      ...
      body: "Roughly every six months, we coordinate an online meeting between you and your sponsored child, always facilitated by a MyFundAction or Ufuk representative for the child's safety.",
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-12 sm:py-16">
      ...
      <p className="mt-3 text-muted max-w-2xl">
        ...
        {formatMoney(amount, settings.currency)} every {settings.distributionFrequencyMonths} months. Here's exactly
