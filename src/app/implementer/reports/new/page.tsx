...
export default async function NewReportPage({ searchParams }: { searchParams: Promise<{ childId?: string }> }) {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <p className="text-sm text-muted mb-6">Save as draft anytime, or submit when ready for MyFundAction&rsquo;s review.</p>
      <Card>
        <CardContent className="pt-6">
          <ReportForm childOptions={children} defaultChildId={childId} />
        </CardContent>
      </Card>
    </div>
  );
